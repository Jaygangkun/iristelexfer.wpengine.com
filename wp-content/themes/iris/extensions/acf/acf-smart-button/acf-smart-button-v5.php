...
class acf_field_smart_button extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->settings = array(
			'url' => get_template_directory_uri() . '/extensions/acf/acf-smart-button/',
			'path' => get_template_directory() . '/extensions/acf/acf-smart-button/',
			'version' => '1.0.0'
		);
	...
	function render_field( $field ) {
		...
		?>
			...
			<table class="acf-smart-button-fields">
				<tr>
					<td valign="top">
						<label><?php _e('Button Text', 'acf-smart-button'); ?></label>
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		$dir = get_template_directory_uri() . '/extensions/acf/acf-smart-button/';
		// register & include JS
