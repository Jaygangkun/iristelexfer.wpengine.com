...
function acf_smart_button_load_textdomain() {
 load_plugin_textdomain( 'acf-smart-button', false, get_template_directory() . '/extensions/acf/acf-smart-button/lang/' );
}
// 2. Include field type for ACF5
// $version = 5 and can be ignored until ACF6 exists
function include_field_types_smart_button( $version ) {
	include_once(dirname(__FILE__) . '/acf-smart-button-v5.php');
}
